...
//
// Tier A — SmolLM2-360M-Instruct on WebGPU via transformers.js (~230 MB, English-only)
// Tier B — SmolLM2-360M-Instruct wllama WASM (~230 MB, 2 GB+ RAM, English-only)
// (Tiers A and B share a model; A just runs it on WebGPU for speed.)
