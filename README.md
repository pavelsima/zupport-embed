...
- **Desktop:** runs an in-browser LLM (Qwen2.5-0.5B on WebGPU, or SmolLM2-360M via WASM) over your knowledge-base vectors, with a scenario short-circuit that returns curated answers when confidence is high. English-only.
