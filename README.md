...
- **Desktop:** runs an in-browser LLM (Qwen3-0.6B on WebGPU with thinking disabled, SmolLM2-360M via WASM) over your knowledge-base vectors, with a scenario short-circuit that returns curated answers when confidence is high. English-only.
